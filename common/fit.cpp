...
enum common_params_fit_status common_fit_params(
    ...
    try {
        common_params_fit_impl(path_model, mparams, cparams, param_offloader_arena,
            tensor_split, tensor_buft_overrides, margins, n_ctx_min, log_level);
...
void common_fit_print(
    ...
    auto dmd = common_get_device_memory_data_impl(
        path_model, mparams, cparams, nullptr, devs, hp_ngl, hp_nct, hp_nex, GGML_LOG_LEVEL_ERROR);
